...
import { getOrderList, orderData, orderCancel, orderPay, orderDel } from '../../api/order.js';
...
Page({
  ...
  data: {
    ...
    orderList: [],//订单数组
    orderData: {},//订单详细统计
    orderStatus:0,//订单状态 0待付款 1代发货 2待收货 3待评价 4已完成
    page:1,
    limit:10,
    isClose:false,
    payMode:[
...
//       {
//         "productInfo": {
//           "image": "https://img.alicdn.com/imgextra/i2/40813400/O1CN01yd29xI1azF6rBaaev_!!0-saturn_solar.jpg_240x240xz.jpg_.webp",
...
//   "sum_price": "1566.00",
//   "unpaid_count": 2,    // 待付款
//   "unshipped_count": 1, // 待发货
//   "received_count": 1,  // 待收货
//   "evaluated_count": 1, // 待评价
//   "complete_count": 1   // 已完成
// }